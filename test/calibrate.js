...
// var calibrationFactor = -7050.0; // Seeed Studio 5kg
var calibrationFactor = -7050.0; // 5kg Taylor load cell
...
function setupHX711() {
  ...
  var zeroFactor = scale.readAverage(); // Get a baseline reading
